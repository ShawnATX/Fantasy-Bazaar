...
const PrivacyPolicy = () => {
  return (
    <Container>
      ...
      <Row className='my-4'>
        <Col sm={8}>
          <h1>Privacy Policy of Fantasy Bazaar</h1>
        </Col>
        <Col className='d-flex'>
          <A href='/' alt='Back Home' className='ms-auto'>
            <Button className='btn-small ms-auto' variant='secondary'>
              Back Home
            </Button>
          </A>
        </Col>
      ...
      <p>
        fantasybazaar.app operates the fantasybazaar.app website, which provides
        the SERVICE.
      </p>
      <p>
        This page is used to inform website visitors regarding our policies with
        the collection, use, and disclosure of Personal Information if anyone
        decided to use our Service, the Fantasy Bazaar website.
      </p>
      ...
      <p>
        ...
        Terms and Conditions, which is accessible at fantasybazaar.app, unless
